...
| 3c-4 | Stage C (1000 → 1700 M, +4.7 日, optional) | [#3](https://github.com/s-sasaki-earthsea-wizard/gw150914-einstein-toolkit/issues/3) | 未着手 (ψ4 peak 捕捉に必要、Phase 4 結果次第で go/no-go) |
| 4 | 軌道・波形の抽出とプロット (+ Zenodo N=28 比較) | [#4](https://github.com/s-sasaki-earthsea-wizard/gw150914-einstein-toolkit/issues/4) | 🔄 進行中 (Stage A/B 比較完了 2026-04-30、Stage B overall_pass=True) |
...
## Phase 4 メモ (Stage A / Stage B 比較, Issue #4)
